...
/**
 * string_nconcat - concatenates two strings, using at most `n` bytes from the second string.
 *
 * This function concatenates the two strings `s1` and `s2`, using at most `n` bytes from `s2`.
